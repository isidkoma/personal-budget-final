...
function testSetIncome() {
	...
	axios.post(BACKEND_URL + "/set_income", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
				testSetSavings();
			} else {
...
function testSetSavings() {
	...
	axios.post(BACKEND_URL + "/set_savings", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
				testAddToBudget1();
			} else {
...
function testAddToBudget1() {
	...
	axios.post(BACKEND_URL + "/add_to_budget", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
				testAddToBudget2();
			} else {
...
function testSignOutAll() {
	...
	axios.post(BACKEND_URL + "/sign_out_all", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
				testLogin1();
			} else {
...
function testChangePassword() {
	...
	axios.post(BACKEND_URL + "/change_password", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
				testLogin2();
			} else {
...
function testGetBudget1() {
	...
	axios.post(BACKEND_URL + "/get_budget", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
...
function testDeleteFromBudget() {
	...
	axios.post(BACKEND_URL + "/delete_from_budget", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
				testGetBudget2();
			} else {
...
function testDeleteAccount() {
	...
	axios.post(BACKEND_URL + "/delete_account", data).then((res) => {
		if (res && res.data) {
			if (res.data.ok === 1) {
